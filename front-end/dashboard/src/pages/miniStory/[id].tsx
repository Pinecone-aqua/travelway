    ...
    <div className="bg-white rounded-2xl h-full p-20 flex flex-col w-full">
      <div className="w-full h-[350px] bg-slate-100 rounded-2xl flex justify-around">
        <div className="flex items-center">
          <div className="w-[200px] h-32 m-5 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl p-4 flex">
            <div>
              <p className="font-bold text-xl">travels</p>
              <p className="text-[60px]">{travels.length}</p>
            </div>
          </div>
          <div className="w-[200px] h-32 m-5 text-white bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%  rounded-2xl p-4 flex">
            <div>
              <p className="font-bold text-xl">mini story</p>
          ...
          <div className="w-[200px] h-32 m-5 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl p-4 flex">
            <div className="flex flex-col justify-between">
              ...
              <p className="text-[35px]">{user.phone}</p>
            </div>
          </div>
          <div className="w-[200px] h-32 m-5 text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl p-4 flex">
            <div>
              <p className="font-bold text-xl">role</p>
              <p className="text-[60px]">{user.role}</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-2xl w-1/4 h-[80%] m-5 p-5 flex flex-col justify-between items-center">
          ...
          <p className="text-3xl font-bold w-[90%] border-b-2 text-mycolor">
            #{user.username}#
          </p>
          <div className="border-b-2 w-[90%]">
            <p className="text-2xl font-bold">TravelWay member since</p>
            <p className="text-xl font-bold  text-mycolor">
          ...
          <div className="w-[90%]">
            ...
            <textarea
              name=""
              id=""
              className="text-xl w-full text-mycolor font-bold"
